...
> I chose this IP Address Tracking App project because IP monitoring is frequently used by security experts to pinpoint the location of suspicious activity, attacks, or illegal access attempts. 
> I will continue to work on this web application to finalize its functionality and integrate more robust security features. To make it even more security-focused, I want to include features like threat intelligence integration, IP reputation > checking, or historical tracking capabilities.

# It doesn't matter how many times you fail; only how many times you get up! #
...
This project presented several challenging debugging scenarios that taught me valuable problem-solving skills, determination, and persistence. 
...
Time Constraints Solution: Due to project deadlines and the complexity of resolving the Git issues, I had to resort to manually copying and pasting all project files into a fresh remote repository. While not ideal, I submitted files successfully.
